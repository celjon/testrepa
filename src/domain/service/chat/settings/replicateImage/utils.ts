...
export const defaultSettings: Omit<IChatReplicateImageSettings, 'id' | 'created_at' | 'model' | 'output_format'> = {
  aspect_ratio: '1:1',
  steps: 25,
  guidance: 3,
  interval: 2,
...
export const getAspectRatio = <T extends string>(aspectRatios: readonly T[], aspectRatio?: string): T => {
  if (!aspectRatio) {
