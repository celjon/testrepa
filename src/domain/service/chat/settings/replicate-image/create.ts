...
export type Create = (params: {
  defaultModel: Pick<IModel, 'id' | 'parent_id'>
  settings?: Partial<Omit<IChatReplicateImageSettings, 'model'>> &
    Pick<IChatReplicateImageSettings, 'model'>
...
export const buildCreate = (): Create => {
  ...
  return ({ defaultModel, settings }) => {
    ...
    throw new InvalidDataError({
      ...
      message: `Model ${defaultModel.parent_id}/${settings?.model} is not supported`,
    })
  }
}
