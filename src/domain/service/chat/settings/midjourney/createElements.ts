...
import { IChatMidjourneySettings, IChatSettingsElement } from '@/domain/entity/chatSettings'
import { MidjourneyMode } from '@prisma/client'

export type CreateElements = (params: { chat: IChat; settings: IChatMidjourneySettings }) => IChatSettingsElement[]
      ...
      },
      {
        ...
        value:
          settings.version === '7' && settings.mode !== MidjourneyMode.RELAX
            ...
            : settings.mode === MidjourneyMode.TURBO && settings.version !== '5.2' && settings.version !== '7'
              ? MidjourneyMode.FAST
              : settings.mode,
        data: [
          {
