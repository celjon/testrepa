...
export const translations: Record<Locale, Translation> = {
  en: {
    ...
    softLimitMail: {
      ...
      subtitle: 'We are notifying you that your organization is approaching the soft limit of resources in your account.',
      body1: 'According to the data, the current usage of resources is greater than the specified value.',
      body2:
      ...
      body3: 'If you have any questions, send an email to contact@bothub.chat, we are here to help!',
  ...
  es: {
    ...
    softLimitMail: {
      ...
      subtitle: 'Le informamos que su organización está acercando al límite suave de recursos en su cuenta.',
      ...
      body3: 'Si tiene alguna pregunta, envíe un correo electrónico a contact@bothub.chat, estamos aquí para ayudarlo!',
  ...
  fr: {
    ...
    welcomeMail: {
      ...
      subtitle: 'Vous avez enregistré avec succès, utilisez les données pour accéder au tableau de bord personnel.',
      profile: 'Profil'
    },
    ...
    softLimitMail: {
      ...
      subtitle: 'Nous vous informons que votre organisation est proche de la limite de ressources de votre compte.',
      body1: "Selon les données, l'utilisation actuelle des ressources est supérieure au montant spécifié.",
      body2:
      ...
      body3: 'Si vous avez des questions, envoyez un e-mail à contact@bothub.chat, nous sommes là pour vous aider!',
  ...
  pt: {
    ...
    softLimitMail: {
      title: 'Olá, tudo bem?',
      subtitle: 'Estamos avisando que sua organização está atingindo o limite de uso de recursos em sua conta.',
      ...
      body3: 'Caso tenha alguma dúvida, envie um e-mail para contato@bothub.chat, estamos à disposição para ajudar!',
  ...
  ru: {
    ...
    verificationMail: {
      ...
      subtitle: 'Вы успешно зарегистрировались, используйте данный код для подтверждения вашей почты.',
      yourCode: 'Ваш код'
    },
    ...
    softLimitMail: {
      title: 'Добрый день!',
      subtitle: 'Уведомляем Вас о том, что Ваша организация приближается к установленному soft лимиту использования caps.',
      body1: 'Согласно статистике, текущий объем использования ресурсов близок к заданному Вами пороговому значению.',
      body2:
      ...
      body3: 'В случае возникновения вопросов - пишите в чат в телеграмме, мы с радостью поможем разобраться!',
