...
export type DeriveKEK = (params: { password: string; kekSalt: Uint8Array<ArrayBufferLike> }) => Promise<string>

export type GenerateDEK = () => Promise<Buffer>

export type EncryptDEK = (params: { kek: string; dek: Uint8Array<ArrayBufferLike> }) => Promise<Buffer>

export type DecryptDEK = (params: { kek: string; edek: Uint8Array<ArrayBufferLike> }) => Promise<Buffer>

export type Encrypt = (params: { dek: Uint8Array<ArrayBufferLike>; data: string }) => Promise<string>

export type Decrypt = (params: { dek: Uint8Array<ArrayBufferLike>; encryptedData: string }) => Promise<string>
