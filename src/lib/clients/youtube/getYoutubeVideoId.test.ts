...
describe('getYoutubeVideoId', () => {
  ...
  test('standard url with query params', () => {
    const videoURL = 'https://www.youtube.com/watch?v=qcC_DGkFRSA&list=PL7y-1kgxy-f3f-3i9-8-7-6-5-4-3-2-1-0'
    const result = getYoutubeVideoId(videoURL)
  ...
  test('standard url with query params and hash', () => {
    const videoURL = 'https://www.youtube.com/watch?v=qcC_DGkFRSA&list=PL7y-1kgxy-f3f-3i9-8-7-6-5-4-3-2-1-0#t=0m0s'
    const result = getYoutubeVideoId(videoURL)
