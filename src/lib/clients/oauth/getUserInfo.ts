...
import { GetUserInfo, UserInfo } from './types'

type UserInfoGetter = (params: { axiosInstance: Axios; access_token: string; providerConfig: OAuthProviders[string] }) => Promise<UserInfo>
...
const getYandexUserInfo: UserInfoGetter = async ({ axiosInstance, access_token, providerConfig }) => {
