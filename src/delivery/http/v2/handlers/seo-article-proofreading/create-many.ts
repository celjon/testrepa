...
export const buildCreateManySEOArticleProofreading = ({ seoArticleProofreading }: Params): CreateManySEOArticleProofreading => {
  return async (req, res) => {
    ...
    try {
      ...
      const createdCount = await seoArticleProofreading.createManySEOArticleProofreading({ proofreadings })
